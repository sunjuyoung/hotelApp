...
import com.example.hotelApi.security.filter.ApiLoginFilter;
import com.example.hotelApi.security.filter.TokenCheckFilter;
...
public class CustomSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        http.authorizeRequests().antMatchers("/refreshToken","/api/room/image/**").permitAll();
